				...
				<div class="col-md-6 col-lg-5">
					...
					<div class="card shadow-lg">
						...
						if (isset($_SESSION["no"])){
							...
							header("Location: kullanici/default.php");
						}
						...
						if (isset($_POST["login"])){
							...
							echo $formdanGelenSifre=temizle($_POST["sifre"]);
								...
								try {
									...
									/*
									$kullanici=array("kullanici_no"=>11, "kullanici_adi"=>"Furkan", "kullanici_soyadi"=>"Aydin");
									
									echo $kullanici["kullanici_soyadi"];
									
									*/
									/* Veri tabanından gelen verileri var ise $kullanici değişkenin içerisine dizi olarak aktarır.*/
									$kullanici=$sorgu->fetch();
										...
										if ($kullanici){
											...
											if (password_verify($formdanGelenSifre, $kullanici["kullanici_sifre"])){
												...
												$_SESSION["no"]=$kullanici["kullanici_no"];
												$_SESSION["adi"]=$kullanici["kullanici_adi"];
												$_SESSION["soyadi"]=$kullanici["kullanici_soyadi"];
												$_SESSION["kadi"]=$kullanici["kullanici_eposta"];
