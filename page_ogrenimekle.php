            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item " aria-current="page">Yeni Öğrenim Bilgisi Ekle</li>
               ...
               <!--begin::Quick Example-->
                <div class="card card-primary card-outline mb-4">
                  ...
                  <div class="card-header">
                    <div class="card-title">Yeni Öğrenim Bilgisi Ekle</div>
                  </div>
                  <!--end::Header-->
                  <!--begin::Form-->
                  ...
                  if($_POST){
                    ...
                    $ekle=$code->ekleOgrenimBilgisi($entity);
                    if ($ekle){
                      ?>
                  ...
                  <form method="post">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        <label for="seviye" class="form-label">Öğrenim Seviyesi</label>
                         ...
                         <option value="4">Önlisans</option>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="ogrenim_kurumadi" name="ogrenim_kurumadi" value="" required />
                      </div>
                    ...
                    <div class="card-footer text-end">
                      <button type="submit" class="btn btn-warning" ><i class="bi bi-plus"></i>Öğrenim Bilgisini Ekle</button>
                    </div>
                    <!--end::Footer-->
                  </form>
                  <!--end::Form-->
